...
public final class aw
{
  ...
  private aw(Context paramContext, ViewGroup paramViewGroup, ax paramax)
  {
  ...
  public static aw a(ViewGroup paramViewGroup, float paramFloat, ax paramax)
  {
    aw localaw = new aw(paramViewGroup.getContext(), paramViewGroup, paramax);
    localaw.b = ((int)(localaw.b * (1.0F / paramFloat)));
    return localaw;
  }
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label250: for (float f2 = i10 / i11; ; f2 = i8 / i12)
    {
  ...
  {
    int i1 = af.c(paramMotionEvent);
    for (int i2 = 0; i2 < i1; i2++)
    {
      int i3 = af.b(paramMotionEvent, i2);
      float f1 = af.c(paramMotionEvent, i2);
      float f2 = af.d(paramMotionEvent, i2);
      this.f[i3] = f1;
      this.g[i3] = f2;
    }
  }
  ...
  private void g()
  {
    ...
    a(a(ar.a(this.l, this.c), this.n, this.m), a(ar.b(this.l, this.c), this.n, this.m));
  }
  ...
  public final boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)ar.a(this.l, this.c), (int)ar.b(this.l, this.c));
  }
  ...
  public final boolean a(MotionEvent paramMotionEvent)
  {
    ...
    while (this.a == 1)
    {
      ...
      int i12 = af.b(paramMotionEvent, 0);
      a(f7, f8, i12);
      ...
      if ((this.h[i12] & this.p) != 0)
      {
        ...
        localax2.b();
        continue;
        int i11 = af.b(paramMotionEvent, i2);
        float f5 = af.c(paramMotionEvent, i2);
        float f6 = af.d(paramMotionEvent, i2);
        a(f5, f6, i11);
        if (this.a == 0)
        {
        ...
        else if (this.a == 2)
        {
          ...
          if (localView2 == this.s)
          {
            ...
            for (int i4 = 0; ; i4++)
            {
              ...
              if (i4 < i3)
              {
                i5 = af.b(paramMotionEvent, i4);
                float f1 = af.c(paramMotionEvent, i4);
                float f2 = af.d(paramMotionEvent, i4);
                f3 = f1 - this.d[i5];
                f4 = f2 - this.e[i5];
  ...
  public final boolean a(boolean paramBoolean)
  {
    if (this.a == 2)
    {
      ...
      if ((i4 != 0) || (i5 != 0))
        this.r.a(this.s, i2);
      if ((bool2) && (i2 == this.q.d()) && (i3 == this.q.e()))
      {
        this.q.h();
        bool2 = false;
      }
  ...
  {
    int i1 = 0;
    int i2 = af.a(paramMotionEvent);
    int i3 = af.b(paramMotionEvent);
    if (i2 == 0)
      e();
    if (this.l == null)
      this.l = VelocityTracker.obtain();
    ...
    case 5:
      ...
      do
      {
        ...
        do
        {
          ...
          localax2.b();
          return;
          i17 = af.b(paramMotionEvent, i3);
          f9 = af.c(paramMotionEvent, i3);
          f10 = af.d(paramMotionEvent, i3);
          a(f9, f10, i17);
          if (this.a != 0)
            break;
    ...
    case 2:
      if (this.a == 1)
      {
        int i10 = af.a(paramMotionEvent, this.c);
        float f7 = af.c(paramMotionEvent, i10);
        float f8 = af.d(paramMotionEvent, i10);
      ...
      int i8 = af.c(paramMotionEvent);
      while (i1 < i8)
      {
        int i9 = af.b(paramMotionEvent, i1);
        float f3 = af.c(paramMotionEvent, i1);
        float f4 = af.d(paramMotionEvent, i1);
      ...
      return;
    case 6:
      i4 = af.b(paramMotionEvent, i3);
      if ((this.a == 1) && (i4 == this.c))
      {
        int i5 = af.c(paramMotionEvent);
        if (i1 >= i5)
          break label778;
        int i7 = af.b(paramMotionEvent, i1);
        if (i7 == this.c)
          break label736;
        float f1 = af.c(paramMotionEvent, i1);
        float f2 = af.d(paramMotionEvent, i1);
