  ...
  implements g, Filterable
{
  ...
  public c(Context paramContext, Cursor paramCursor, int paramInt)
  {
    a(paramContext, paramCursor, paramInt);
  }

  public c(Context paramContext, Cursor paramCursor, boolean paramBoolean)
  {
  ...
  private void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (this.g = new e(this, (byte)0); ; this.g = null)
    {
      if (j != 0)
      {
        if (this.f != null)
  ...
  public final void a(FilterQueryProvider paramFilterQueryProvider)
  {
