...
public abstract class s
{
  ...
  public abstract s a(int paramInt);

  public abstract s a(int paramInt1, int paramInt2);
  ...
  public abstract s a(String paramString);

  public abstract int b();

  public abstract s b(int paramInt, Fragment paramFragment);

  public abstract s b(int paramInt, Fragment paramFragment, String paramString);
