...
public class k extends Activity
{
  ...
  textnow.e.o<String, ab> mAllLoaderManagers;
  boolean mCheckedForLoaderManager;
  final m mContainer = new m()
  {
    public final View a(int paramAnonymousInt)
    {
      return k.this.findViewById(paramAnonymousInt);
    }

    public final boolean a()
    {
      Window localWindow = k.this.getWindow();
      return (localWindow != null) && (localWindow.peekDecorView() != null);
    }
  };
  boolean mCreated;
  final o mFragments = new o();
  final Handler mHandler = new Handler()
  {
    public final void handleMessage(Message paramAnonymousMessage)
    {
      ...
      case 1:
        do
          return;
        while (!k.this.mStopped);
        k.this.doReallyStop(false);
        return;
      case 2:
      }
      k.this.onResumeFragments();
      k.this.mFragments.f();
    }
  };
  ab mLoaderManager;
  ...
  ab getLoaderManager(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (this.mAllLoaderManagers == null)
      this.mAllLoaderManagers = new textnow.e.o();
    ab localab = (ab)this.mAllLoaderManagers.get(paramString);
    if (localab == null)
    {
      if (paramBoolean2)
      {
        localab = new ab(paramString, this, paramBoolean1);
        this.mAllLoaderManagers.put(paramString, localab);
      }
      return localab;
    }
    localab.a(this);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    l locall = (l)getLastNonConfigurationInstance();
    if (locall != null)
      this.mAllLoaderManagers = locall.e;
    Parcelable localParcelable;
    o localo;
    if (paramBundle != null)
    {
      localParcelable = paramBundle.getParcelable("android:support:fragments");
      localo = this.mFragments;
      if (locall == null)
        break label99;
    }
    label99: for (ArrayList localArrayList = locall.d; ; localArrayList = null)
    {
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (this.mAllLoaderManagers != null)
    {
      ...
      ab[] arrayOfab = new ab[k];
      for (int m = k - 1; m >= 0; m--)
        arrayOfab[m] = ((ab)this.mAllLoaderManagers.c(m));
      j = 0;
      if (i < k)
      {
        ...
        while (true)
        {
          ...
          break;
          localab.h();
          this.mAllLoaderManagers.remove(localab.d);
        }
      }
    }
    else
    ...
    locall.e = this.mAllLoaderManagers;
    return locall;
  }
  ...
  protected void onStart()
  {
    ...
    while (true)
    {
      ...
      arrayOfab = new ab[i];
      for (int j = i - 1; j >= 0; j--)
        arrayOfab[j] = ((ab)this.mAllLoaderManagers.c(j));
