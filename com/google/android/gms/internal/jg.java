...
{
  private final jj<je> VJ = new jg.c(this, null);
  ...
  public void addGeofences(List<jh> paramList, PendingIntent paramPendingIntent, LocationClient.OnAddGeofencesResultListener paramOnAddGeofencesResultListener)
  {
    ...
    label78: for (Object localObject = null; ; localObject = new jg.b(paramOnAddGeofencesResultListener, this))
    {
      ((je)ft()).a(paramList, paramPendingIntent, (jd)localObject, getContext().getPackageName());
      return;
      bool = false;
      break;
    }
  ...
  public void removeGeofences(PendingIntent paramPendingIntent, LocationClient.OnRemoveGeofencesResultListener paramOnRemoveGeofencesResultListener)
  {
    ...
    for (Object localObject = null; ; localObject = new jg.b(paramOnRemoveGeofencesResultListener, this))
    {
      ((je)ft()).a(paramPendingIntent, (jd)localObject, getContext().getPackageName());
      return;
    }
  }
  ...
  public void removeGeofences(List<String> paramList, LocationClient.OnRemoveGeofencesResultListener paramOnRemoveGeofencesResultListener)
  {
    ...
    label83: for (Object localObject = null; ; localObject = new jg.b(paramOnRemoveGeofencesResultListener, this))
    {
      ((je)ft()).a(arrayOfString, (jd)localObject, getContext().getPackageName());
      return;
      bool = false;
      break;
    }
