  ...
  implements SafeParcelable
{
  ...
  static fg a(Intent paramIntent, String paramString1, Uri paramUri, String paramString2, List<AppIndexApi.AppIndexingLink> paramList)
  {
    ...
    if (str1 != null)
      localArrayList.add(f("intent_action", str1));
    String str2 = paramIntent.getDataString();
    if (str2 != null)
      localArrayList.add(f("intent_data", str2));
    ComponentName localComponentName = paramIntent.getComponent();
    if (localComponentName != null)
      localArrayList.add(f("intent_activity", localComponentName.getClassName()));
    Bundle localBundle = paramIntent.getExtras();
    if (localBundle != null)
    {
      String str3 = localBundle.getString("intent_extra_data_key");
      if (str3 != null)
        localArrayList.add(f("intent_extra_data", str3));
    }
  ...
  public String toString()
  {
    ...
    arrayOfObject[0] = this.yq;
    arrayOfObject[1] = Long.valueOf(this.yr);
    arrayOfObject[2] = Integer.valueOf(this.ys);
