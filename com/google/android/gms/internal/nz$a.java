...
public final class nz$a extends jj
  implements Person.AgeRange
{
  ...
  static
  {
    ...
    amb = localHashMap;
    localHashMap.put("max", ji.a.i("max", 2));
  ...
  nz$a(Set<Integer> paramSet, int paramInt1, int paramInt2, int paramInt3)
  {
    this.amc = paramSet;
    this.BR = paramInt1;
    this.ant = paramInt2;
 ...
 * Qualified Name:     com.google.android.gms.internal.nz.a
