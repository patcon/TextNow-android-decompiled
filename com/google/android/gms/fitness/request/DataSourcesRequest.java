  ...
  implements SafeParcelable
{
  ...
  {
    this.BR = 2;
    this.SB = jr.b(DataSourcesRequest.Builder.a(paramBuilder));
    this.Uw = Arrays.asList(jr.a(DataSourcesRequest.Builder.b(paramBuilder)));
    this.Ux = DataSourcesRequest.Builder.c(paramBuilder);
  }
