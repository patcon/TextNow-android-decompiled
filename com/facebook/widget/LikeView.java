...
public class LikeView extends FrameLayout
{
  ...
  private void associateWithLikeActionController(LikeActionController paramLikeActionController)
  {
    ...
    localm.a(this.broadcastReceiver, localIntentFilter);
  }
  ...
  private void parseAttributes(AttributeSet paramAttributeSet)
  {
    ...
    {
      return;
      localTypedArray = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.com_facebook_like_view);
    }
  ...
  private void tearDownObjectAssociations()
  {
    ...
    {
      m.a(getContext()).a(this.broadcastReceiver);
  ...
  private void updateBoxCountCaretPosition()
  {
    ...
    switch (2.$SwitchMap$com$facebook$widget$LikeView$AuxiliaryViewPosition[this.auxiliaryViewPosition.ordinal()])
    {
    default:
      return;
    case 1:
  ...
  private void updateLayout()
  {
    ...
    if (this.horizontalAlignment == LikeView.HorizontalAlignment.LEFT)
    {
      ...
      label106: ((View)localObject).setVisibility(0);
    ...
    while (true)
      ...
      default:
        ...
        break label106;
        label306: this.containerView.removeView((View)localObject);
