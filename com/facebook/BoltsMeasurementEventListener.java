...
public class BoltsMeasurementEventListener extends BroadcastReceiver
{
  ...
  private void close()
  {
    m.a(this.applicationContext).a(this);
  }
  ...
  static BoltsMeasurementEventListener getInstance(Context paramContext)
  {
    if (_instance != null)
      return _instance;
    BoltsMeasurementEventListener localBoltsMeasurementEventListener = new BoltsMeasurementEventListener(paramContext);
  ...
  private void open()
  {
    m.a(this.applicationContext).a(this, new IntentFilter("com.parse.bolts.measurement_event"));
  }
