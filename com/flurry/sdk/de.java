  ...
  implements eu
{
  ...
  protected String d(byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    df localdf = new df();
    localdf.a(paramArrayOfByte);
    String str2 = localdf.a();
    this.f.a(localdf, str1);
    return str2;
  }
  ...
  protected void f()
  {
    ...
    do
    {
      ...
      while (!e());
      List localList2 = this.f.c(str1);
      eo.a(4, this.d, "Number of not sent blocks = " + localList2.size());
      i = 0;
      if (i >= localList2.size())
        break label229;
      str2 = (String)localList2.get(i);
