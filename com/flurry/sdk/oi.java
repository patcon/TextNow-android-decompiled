  ...
  implements is
{
  ...
  public oi(mq parammq, qv paramqv, im paramim, sh paramsh1, jk<Object> paramjk, jz paramjz, sh paramsh2, Method paramMethod, Field paramField, boolean paramBoolean, Object paramObject)
  {
    ...
    this.i = paramjk;
    if (paramjk == null);
    for (ov localov = ov.a(); ; localov = null)
    {
      this.j = localov;
      this.n = paramjz;
      this.h = paramsh2;
  ...
  {
    if (this.o != null);
    for (ov.d locald = paramov.a(paramjw.a(this.o, paramClass), paramjw, this); ; locald = paramov.a(paramClass, paramjw, this))
    {
      if (paramov != locald.b)
        this.j = locald.b;
      return locald.a;
  ...
  public String toString()
  {
    ...
    while (true)
    {
      ...
      break;
      label135: localStringBuilder.append(", static serializer of type " + this.i.getClass().getName());
    }
  }
}

/* Location:           /home/patcon/Downloads/com.enflick.android.TextNow-2-dex2jar.jar
 * Qualified Name:     com.flurry.sdk.oi
