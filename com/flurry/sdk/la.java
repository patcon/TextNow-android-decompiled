...
public class la
{
  ...
  public kx a(iy paramiy)
  {
    ...
    if (this.i == null);
    for (sh localsh = null; ; localsh = this.a.j().a(this.i.b(0)))
    {
      localmd.a(this.c, this.i, localsh, this.j, this.k);
      localmd.a(this.d);
      localmd.b(this.e);
      localmd.c(this.f);
      localmd.d(this.g);
  ...
  public void a(mu parammu, lb[] paramArrayOflb)
  {
    ...
    if (paramArrayOflb.length > 1)
    {
      ...
      int m = paramArrayOflb.length;
      for (int n = 0; n < m; n++)
      {
        String str = paramArrayOflb[n].c();
        Integer localInteger = (Integer)localHashMap.put(str, Integer.valueOf(n));
        if (localInteger != null)
          throw new IllegalArgumentException("Duplicate creator property \"" + str + "\" (index " + localInteger + " vs " + n + ")");
      }
    }
