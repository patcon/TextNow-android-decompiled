...
public final class bx extends AdNetworkView
{
  ...
  public final void initLayout()
  {
    ...
    int k = by.a(new Point(i, j));
    if (-1 == k)
    {
      eo.a(3, a, "Could not find Millennial AdSize that matches size " + i + "x" + j);
      eo.a(3, a, "Could not load Millennial Ad");
      return;
    }
    Point localPoint = by.a(k);
    if (localPoint == null)
    {
      eo.a(3, a, "Could not find Millennial AdSize that matches size " + i + "x" + j);
      eo.a(3, a, "Could not load Millennial Ad");
    ...
    int m = localPoint.x;
    int n = localPoint.y;
    eo.a(3, a, "Determined Millennial AdSize as " + m + "x" + n);
