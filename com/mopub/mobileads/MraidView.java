  ...
  implements ViewGestureDetector.UserClickListener
{
  ...
  private void initialize(MraidView.ExpansionStyle paramExpansionStyle, MraidView.NativeCloseButtonStyle paramNativeCloseButtonStyle)
  {
    ...
    setOnTouchListener(new View.OnTouchListener()
    {
      ...
      {
        MraidView.this.mViewGestureDetector.sendTouchEvent(paramAnonymousMotionEvent);
  ...
  private boolean tryCommand(URI paramURI)
  {
    ...
    MraidCommand localMraidCommand = MraidCommandFactory.create(str, localHashMap, this);
    if (localMraidCommand == null)
    {
      fireNativeCommandCompleteEvent(str);
      return false;
    }
    if ((localMraidCommand.isCommandDependentOnUserClick(this.mPlacementType)) && (!wasClicked()))
      return false;
  ...
  protected void fireChangeEventForProperties(ArrayList<MraidProperty> paramArrayList)
  {
    ...
    new StringBuilder().append("Fire changes: ").append(str2).toString();
  }
  ...
  protected void fireChangeEventForProperty(MraidProperty paramMraidProperty)
  {
    ...
    new StringBuilder().append("Fire change: ").append(str).toString();
  }

  protected void fireErrorEvent(MraidCommandFactory.MraidJavascriptCommand paramMraidJavascriptCommand, String paramString)
  {
    String str = paramMraidJavascriptCommand.getCommand();
    injectJavaScript("window.mraidbridge.fireErrorEvent('" + str + "', '" + paramString + "');");
  }
  ...
  public void loadUrl(String paramString)
  {
    ...
    try
    {
      ...
      {
        String str = Strings.fromStream(localHttpEntity.getContent());
        localObject = str;
      }
      loadHtmlData((String)localObject);
      return;
    }
