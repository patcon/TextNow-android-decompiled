  ...
  implements Serializable
{
  ...
  static AdConfiguration extractFromMap(Map<String, Object> paramMap)
  {
    if (paramMap == null)
      return null;
    Object localObject = paramMap.get("Ad-Configuration");
    if ((localObject instanceof AdConfiguration))
      return (AdConfiguration)localObject;
    return null;
  }
  ...
  void addHttpResponse(HttpResponse paramHttpResponse)
  {
    ...
    for (this.mRefreshTimeMilliseconds = 0; ; this.mRefreshTimeMilliseconds = Math.max(this.mRefreshTimeMilliseconds, 10000))
    {
      ...
      return;
      this.mRefreshTimeMilliseconds = (1000 * HttpResponses.extractIntHeader(paramHttpResponse, ResponseHeader.REFRESH_TIME, 0));
    }
  }
 ...
 * Qualified Name:     com.mopub.mobileads.AdConfiguration
