...
public class AdViewController
{
  ...
  private void setAutorefreshEnabled(boolean paramBoolean)
  {
    ...
    if ((this.mAdWasLoaded) && (this.mAutoRefreshEnabled != paramBoolean))
    {
      ...
      if (i != 0)
      {
        ...
        label44: MoPubLog.d("Refresh " + str1 + " for ad unit (" + str2 + ").");
      }
  ...
  void loadFailUrl(MoPubErrorCode paramMoPubErrorCode)
  {
    ...
    for (String str = ""; ; str = paramMoPubErrorCode.toString())
    {
  ...
  void registerClick()
  {
    new Thread(new Runnable()
    {
      public void run()
      {
        ...
        try
        {
          MoPubLog.d("Tracking click for: " + AdViewController.this.mAdConfiguration.getClickthroughUrl());
        ...
        {
          MoPubLog.d("Click tracking failed: " + AdViewController.this.mAdConfiguration.getClickthroughUrl(), localException);
          return;
        }
        finally
        {
  ...
  {
    if (paramMap != null);
    for (HashMap localHashMap = new HashMap(paramMap); ; localHashMap = new HashMap())
    {
      this.mLocalExtras = localHashMap;
      return;
    }
  }
  ...
  void trackImpression()
  {
    new Thread(new Runnable()
    {
      public void run()
      {
        ...
        {
          MoPubLog.d("Impression tracking failed : " + AdViewController.this.mAdConfiguration.getImpressionUrl(), localException);
          return;
        }
        finally
        {
