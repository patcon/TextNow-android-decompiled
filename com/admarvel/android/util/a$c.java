...
public class a$c extends AsyncTask<Integer, Void, String>
{
  private final String b;
  private final String c;

  public a$c(a parama, String paramString)
  {
    this.c = paramString;
    this.b = (this.c + ".zip");
  }
    ...
    while (true)
    {
      ...
      try
      {
        ...
        if (localContext != null)
        {
          ...
          String str11 = str10 + com.admarvel.android.ads.a.a;
