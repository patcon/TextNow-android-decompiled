...
class AdMarvelInternalWebView$d extends WebViewClient
{
  private final WeakReference<AdMarvelInternalWebView> a;
  private final WeakReference<Context> b;
  private final AdMarvelAd c;

  public AdMarvelInternalWebView$d(AdMarvelInternalWebView paramAdMarvelInternalWebView, Context paramContext, AdMarvelAd paramAdMarvelAd)
  {
  ...
  public void onLoadResource(WebView paramWebView, String paramString)
  {
    ...
    while ((AdMarvelInternalWebView.a(localAdMarvelInternalWebView)) || (!AdMarvelInternalWebView.g(localAdMarvelInternalWebView)) || (!paramString.contains("mraid.js")))
      return;
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    label1199: if (AdMarvelInterstitialAds.getEnableClickRedirect())
    {
      if ((paramString != null) && (ab.a(paramString, "admarvelsdk") != ab.f.c))
      {
        if (this.c != null)
    ...
    while (true)
    {
      if (this.c != null)
        AdMarvelInterstitialAds.getListener().a(localAdMarvelActivity, paramString, this.c.getSiteId(), this.c.getId(), this.c.getTargetParams(), this.c.getIpAddress());
      return true;
      label1626: if ((paramString != null) && (ab.a(paramString, "admarvelcustomvideo") != ab.f.c))
      {
        if ((localAdMarvelActivity.d()) && (this.c != null))
          AdMarvelInterstitialAds.getListener().a(localAdMarvelActivity, paramString, this.c.getSiteId(), this.c.getId(), this.c.getTargetParams(), this.c.getIpAddress());
        while (true)
 ...
 * Qualified Name:     com.admarvel.android.ads.AdMarvelInternalWebView.d
