  ...
  implements Runnable
{
  ...
  public AdMarvelActivity$y(AdMarvelInternalWebView paramAdMarvelInternalWebView, String paramString1, String paramString2)
  {
          ...
          else
          {
            if ((this.d == null) && (this.c != null))
            {
              Thread localThread1 = new Thread(new Runnable()
              {
                public void run()
                {
                  AdMarvelActivity.y.this.d = BitmapFactory.decodeStream(AdMarvelActivity.y.this.c);
                }
              });
              localThread1.start();
              localThread1.join();
          ...
          if ((this.a.startsWith("http:")) || (this.a.startsWith("https:")))
          {
            ...
            Thread localThread2 = new Thread(new Runnable()
            {
              public void run()
              {
                try
                {
                  AdMarvelActivity.y.this.c = new URL(AdMarvelActivity.y.this.a).openStream();
                  return;
                }
 ...
 * Qualified Name:     com.admarvel.android.ads.AdMarvelActivity.y
