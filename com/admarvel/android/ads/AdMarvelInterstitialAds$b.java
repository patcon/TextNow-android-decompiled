  ...
  implements Runnable
{
  ...
  public AdMarvelInterstitialAds$b(Map<String, Object> paramMap, String paramString1, String paramString2, String paramString3, int paramInt1, String paramString4, AdMarvelInterstitialAds paramAdMarvelInterstitialAds, int paramInt2, String paramString5, Context paramContext)
  {
    this.a = paramMap;
    this.b = paramString1;
    this.c = paramString2;
  ...
  public void run()
  {
    ...
    if ((localAdMarvelInterstitialAds != null) && (localContext != null))
    {
      ...
      localf.executeOnExecutor(localExecutor, arrayOfObject);
    }
  }
}
