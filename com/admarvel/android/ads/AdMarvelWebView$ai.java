  ...
  implements Runnable
{
  ...
  public AdMarvelWebView$ai(AdMarvelWebView paramAdMarvelWebView, AdMarvelInternalWebView paramAdMarvelInternalWebView, String paramString1, String paramString2)
  {
            ...
            if (new File(this.a).exists())
            {
              ...
              if ((this.d == null) && (this.c != null))
              {
                Thread localThread2 = new Thread(new Runnable()
                {
                  public void run()
                  {
                    AdMarvelWebView.ai.this.d = BitmapFactory.decodeStream(AdMarvelWebView.ai.this.c);
                  }
                });
                localThread2.start();
                localThread2.join();
          ...
          if ((this.a.startsWith("http:")) || (this.a.startsWith("https:")))
          {
            ...
            Thread localThread1 = new Thread(new Runnable()
            {
              public void run()
              {
                try
                {
                  AdMarvelWebView.ai.this.c = new URL(AdMarvelWebView.ai.this.a).openStream();
                  return;
                }
 ...
 * Qualified Name:     com.admarvel.android.ads.AdMarvelWebView.ai
