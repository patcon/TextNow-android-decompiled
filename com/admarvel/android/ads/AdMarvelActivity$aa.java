...
class AdMarvelActivity$aa
  implements Runnable
{
  private final WeakReference<AdMarvelActivity> a;
  private final WeakReference<AdMarvelInternalWebView> b;

  public AdMarvelActivity$aa(AdMarvelActivity paramAdMarvelActivity, AdMarvelInternalWebView paramAdMarvelInternalWebView)
  {
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 23	com/admarvel/android/ads/AdMarvelActivity$aa:a	Ljava/lang/ref/WeakReference;
    ...
    //   10: astore_2
    //   11: aload_0
    //   12: getfield 25	com/admarvel/android/ads/AdMarvelActivity$aa:b	Ljava/lang/ref/WeakReference;
    ...
    //   30: return
    //   31: aload_2
    //   32: getstatic 39	com/admarvel/android/ads/AdMarvelActivity:b	I
    ...
    //   48: aload_2
    //   49: invokestatic 52	com/admarvel/android/ads/AdMarvelActivity:c	(Lcom/admarvel/android/ads/AdMarvelActivity;)Ljava/lang/String;
    ...
    //   66: checkcast 68	com/admarvel/android/ads/p
    //   69: astore 4
    //   71: aload_3
    //   72: ifnull +80 -> 152
    //   75: aload 4
    //   77: ifnull +75 -> 152
    //   80: aload_2
    //   81: getfield 72	com/admarvel/android/ads/AdMarvelActivity:d	Z
    //   84: ifeq +93 -> 177
    //   87: aload_2
    //   88: invokestatic 75	com/admarvel/android/ads/AdMarvelActivity:C	(Lcom/admarvel/android/ads/AdMarvelActivity;)Ljava/lang/String;
    //   91: ifnull +61 -> 152
    //   94: aload_2
    //   95: invokestatic 75	com/admarvel/android/ads/AdMarvelActivity:C	(Lcom/admarvel/android/ads/AdMarvelActivity;)Ljava/lang/String;
    ...
    //   117: aload_2
    //   118: invokestatic 75	com/admarvel/android/ads/AdMarvelActivity:C	(Lcom/admarvel/android/ads/AdMarvelActivity;)Ljava/lang/String;
    ...
    //   129: aload 4
    //   131: invokevirtual 88	com/admarvel/android/ads/p:getCurrentPosition	()I
    //   134: i2f
    //   135: ldc 89
    //   137: fdiv
    ...
    //   149: invokevirtual 98	com/admarvel/android/ads/AdMarvelInternalWebView:loadUrl	(Ljava/lang/String;)V
    //   152: aload_2
    //   153: invokestatic 102	com/admarvel/android/ads/AdMarvelActivity:f	(Lcom/admarvel/android/ads/AdMarvelActivity;)Landroid/os/Handler;
    //   156: aload_2
    //   157: invokestatic 106	com/admarvel/android/ads/AdMarvelActivity:z	(Lcom/admarvel/android/ads/AdMarvelActivity;)Lcom/admarvel/android/ads/AdMarvelActivity$aa;
    //   160: ldc2_w 107
    ...
    //   190: aload 4
    //   192: invokevirtual 88	com/admarvel/android/ads/p:getCurrentPosition	()I
    //   195: sipush 1000
    //   198: idiv
    ...
    //   210: invokevirtual 98	com/admarvel/android/ads/AdMarvelInternalWebView:loadUrl	(Ljava/lang/String;)V
    //   213: goto -61 -> 152
    //   216: astore 6
    //   218: aload 6
 ...
 * Qualified Name:     com.admarvel.android.ads.AdMarvelActivity.aa
