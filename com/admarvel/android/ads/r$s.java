  ...
  implements Runnable
{
  ...
  public r$s(d paramd, String paramString1, String paramString2)
  {
          ...
          else
          {
            if ((this.d == null) && (this.c != null))
            {
              Thread localThread1 = new Thread(new Runnable()
              {
                public void run()
                {
                  r.s.this.d = BitmapFactory.decodeStream(r.s.this.c);
                }
              });
              localThread1.start();
              localThread1.join();
          ...
          if ((this.a.startsWith("http:")) || (this.a.startsWith("https:")))
          {
            ...
            Thread localThread2 = new Thread(new Runnable()
            {
              public void run()
              {
                try
                {
                  r.s.this.c = new URL(r.s.this.a).openStream();
                  return;
                }
 ...
 * Qualified Name:     com.admarvel.android.ads.r.s
