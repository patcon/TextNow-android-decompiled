  ...
  implements Runnable
{
  ...
  public AdMarvelView$d(AdMarvelView paramAdMarvelView, AdMarvelAd paramAdMarvelAd)
  {
  ...
  public void run()
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        if ((this.a != null) && (this.a.isMustBeVisible()) && (this.a.getSdkAdNetwork() == AdMarvelUtils.SDKAdNetwork.PULSE3D))
        {
          ...
          if (AdMarvelUtils.isLogDumpEnabled())
            new Handler().postDelayed(new AdMarvelView.e(this.a, localContext), 1000L);
          localr = new r(localContext);
          if ((!AdMarvelView.a) || (AdMarvelView.e(localAdMarvelView)))
            break;
          new b().a(this.a, localContext, new Handler());
          return;
        }
      }
      ...
      continue;
      label321: AdMarvelView.d(localAdMarvelView).a(localContext, localAdMarvelView, this.a.getSiteId(), this.a.getId(), this.a.getTargetParams(), this.a.getIpAddress());
      continue;
      label361: AdMarvelView.a(localAdMarvelView, localView1, this.a);
    }
    if (!AdMarvelView.a)
      localr.a(this.a);
  }
