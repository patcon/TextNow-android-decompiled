...
import com.enflick.android.TextNow.activities.phone.KeyguardDialerActivity;
import textnow.z.f;
import textnow.z.h;
...
public class TNWidget
{
  ...
  public static Intent createConversationIntent(h paramh, Context paramContext, TNWidget.MessageType paramMessageType, String paramString)
  {
    int i = 1;
  ...
  public static PendingIntent getAnswerCallIntent(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    if (paramBoolean);
    for (Object localObject = KeyguardDialerActivity.class; ; localObject = MainActivity.class)
    {
      Intent localIntent = new Intent(paramContext, (Class)localObject);
      localIntent.putExtra("extra_launched_from_widget", paramString);
      localIntent.setAction("widget_action_answer");
  ...
  public static PendingIntent getDialerIntent(f paramf, Context paramContext, int paramInt, String paramString)
  {
    Intent localIntent = new Intent(paramContext, MainActivity.class);
  ...
  public static PendingIntent getRejectCallIntent(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    if (paramBoolean);
    for (Object localObject = KeyguardDialerActivity.class; ; localObject = MainActivity.class)
    {
      Intent localIntent = new Intent(paramContext, (Class)localObject);
      localIntent.putExtra("extra_launched_from_widget", paramString);
      localIntent.setAction("widget_action_reject");
      return PendingIntent.getActivity(paramContext, paramInt, localIntent, 134217728);
    }
  }
