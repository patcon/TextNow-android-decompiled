  ...
  implements TextWatcher
{
  ...
  public final void afterTextChanged(Editable paramEditable)
  {
    ...
    while (true)
    {
      ...
      label229: if (DialerFragment.i().containsKey(str1))
      {
        String str3 = (String)DialerFragment.i().get(str1);
        paramEditable.clear();
