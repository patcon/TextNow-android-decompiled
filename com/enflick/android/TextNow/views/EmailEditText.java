...
public class EmailEditText extends CompoundEditText
{
  ...
  {
    int i = 2;
    String str1 = getContext().getString(2131493068);
    ...
    if (bool1)
    {
      ...
      String str4 = getContext().getString(2131493068);
    ...
    while (true)
    {
      if (arrayOfString.length >= i)
      {
        ...
        if ((!a(1 + arrayOfString[0].length(), str2, 2131493068, "[^a-zA-Z0-9\\Q\\.-\\E]+")) && (!bool2))
          break label232;
      }
  ...
  {
    int i;
    if ((!a(2131493068)) && (!a(toString(), 2131493067, 256)) && (b(2131493068)))
    {
      i = 1;
      if ((i == 0) || ((this.f) && (!e())))
        break label86;
