  ...
  implements Serializable
{
  ...
  public f(String paramString1, int paramInt, String paramString2, String paramString3)
  {
  ...
  public static g a(Context paramContext, Set<String> paramSet, String paramString, int paramInt)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
              ...
              if (paramInt != 2)
                break;
              str3 = x.a(paramContext, paramSet, paramString);
            }
            while (str3 == null);
            return new g(str3, 2);
            if (paramInt != 3)
