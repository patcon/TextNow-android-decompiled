...
public final class w extends c
{
  ...
  public final org.apache.http.entity.mime.content.ContentBody b(android.content.Context paramContext)
  {
    ...
    //   12: aload_0
    //   13: getfield 30	textnow/z/w:a	Ljava/lang/String;
    ...
    //   27: aload_0
    //   28: getfield 30	textnow/z/w:a	Ljava/lang/String;
    ...
    //   51: aload_3
    //   52: aload 5
    //   54: invokestatic 59	textnow/v/n:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    //   57: aload 5
    //   59: invokevirtual 63	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   62: astore 10
    //   64: aload_3
    //   65: invokestatic 66	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   68: aload 5
    //   70: invokestatic 69	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   73: aconst_null
    //   74: astore 11
    //   76: aload 10
    //   78: ifnull +96 -> 174
    ...
    //   183: astore_3
    //   184: aload_3
    //   185: invokestatic 66	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   188: aload 5
    //   190: invokestatic 69	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   193: aconst_null
    //   194: areturn
    //   195: astore_2
    //   196: aconst_null
    ...
    //   202: astore 5
    //   204: aload_3
    //   205: invokestatic 66	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   208: aload 5
    //   210: invokestatic 69	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   213: aload 4
    //   215: athrow
    //   216: aload 10
    //   218: sipush 1024
    //   221: invokestatic 104	textnow/v/f:a	([BI)Landroid/graphics/Bitmap;
    //   224: astore 17
    //   226: aconst_null
    //   227: astore 11
    //   229: aload 17
