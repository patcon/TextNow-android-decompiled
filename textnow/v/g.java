...
public final class g
{
  ...
  public static File a(Context paramContext, h paramh, long paramLong)
  {
    ...
    case 1:
      ...
      localObject = new SimpleDateFormat(paramContext.getString(2131296793)).format(localDate) + ".jpg";
    case 2:
    case 3:
    case 4:
    case 5:
    ...
    while (true)
    {
      ...
      try
      {
        ...
        localObject = str2;
        label165: return new File(localFile, (String)localObject);
        str1 = "/TextNow/TextNow Audio";
        localObject = new SimpleDateFormat(paramContext.getString(2131296794)).format(localDate) + ".3gp";
        continue;
        str1 = "/TextNow/TextNow Video";
        localObject = new SimpleDateFormat(paramContext.getString(2131296792)).format(localDate) + ".3gp";
        continue;
        str1 = "/TextNow/TextNow VM";
        localObject = new SimpleDateFormat(paramContext.getString(2131296795)).format(localDate) + ".wav";
        continue;
        str1 = "/TextNow/Temp";
        localObject = paramLong + ".tmp";
      }
  ...
  public static i a(Context paramContext, h paramh, java.io.InputStream paramInputStream)
  {
    ...
    //   6: aload_0
    //   7: aload_1
    //   8: invokestatic 236	java/lang/System:currentTimeMillis	()J
    //   11: invokestatic 238	textnow/v/g:a	(Landroid/content/Context;Ltextnow/v/h;J)Ljava/io/File;
    //   14: astore_3
    //   15: aload_3
    //   16: ifnull -12 -> 4
    ...
    //   41: pop
    //   42: new 242	java/io/FileOutputStream
    //   45: dup
    //   46: aload_3
    //   47: invokespecial 245	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   50: astore 5
    //   52: aload_2
    //   53: aload 5
    //   55: invokestatic 250	textnow/v/n:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    //   58: aload_2
    //   59: invokestatic 253	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   62: aload 5
    //   64: invokestatic 256	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   67: new 258	textnow/v/i
    //   70: dup
    //   71: aload_3
    //   72: aload_0
    //   73: aload_3
    //   74: aload_1
    //   75: invokestatic 260	textnow/v/g:a	(Landroid/content/Context;Ljava/io/File;Ltextnow/v/h;)Landroid/net/Uri;
    //   78: invokespecial 263	textnow/v/i:<init>	(Ljava/io/File;Landroid/net/Uri;)V
    //   81: areturn
    //   82: astore 7
    //   84: aconst_null
    //   85: astore 5
    ...
    //   91: ifeq +8 -> 99
    //   94: aload_3
    //   95: invokevirtual 266	java/io/File:delete	()Z
    //   98: pop
    //   99: aload_2
    //   100: invokestatic 253	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   103: aload 5
    //   105: invokestatic 256	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   108: aconst_null
    //   109: areturn
    //   110: astore 4
    //   112: aconst_null
    ...
    //   117: astore 6
    //   119: aload_2
    //   120: invokestatic 253	textnow/v/n:a	(Ljava/io/InputStream;)V
    //   123: aload 5
    //   125: invokestatic 256	textnow/v/n:a	(Ljava/io/OutputStream;)V
    //   128: aload 6
    //   130: athrow
    //   131: astore 6
    //   133: goto -14 -> 119
  ...
  {
    String str = new u(paramContext).Q();
    ...
    while (true)
    {
      try
      {
        if (localCursor.moveToFirst())
        {
          ...
          return new v(new File(a(paramContext, str)), i);
        }
      }
      finally
      {
  ...
  private static final Uri b(Context paramContext, File paramFile, long paramLong)
  {
    ...
    String str1 = new SimpleDateFormat(paramContext.getString(2131296410)).format(localDate);
    ContentValues localContentValues = new ContentValues();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    return paramContext.getContentResolver().query(Uri.parse(localu.Q()), a, null, null, null) != null;
  }
