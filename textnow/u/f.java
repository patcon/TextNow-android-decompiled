...
{
  private static String[] a = { "_id", "contact_value", "contact_type", "contact_name", "contact_uri", "latest_message_text", "latest_message_date", "num_unread", "latest_message_type", "latest_message_direction", "custom_wallpaper", "custom_ringtone" };
  private long b;
  private String c;
  private int d;
  private String e;
  ...
  public static Uri a(ContentResolver paramContentResolver, int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    return paramContentResolver.insert(c.d, localContentValues);
  }

  public static d a(Context paramContext)
  {
    return new d(paramContext, c.d, a, null, null, "latest_message_date DESC");
  }

  public static d a(Context paramContext, int paramInt)
  {
    return new d(paramContext, c.d, a, null, null, "latest_message_date DESC LIMIT " + 4);
  }

  public static f a(ContentResolver paramContentResolver, String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (int n = 0; n < paramArrayOfString.length; n++)
          if (!TextUtils.isEmpty(paramArrayOfString[n]))
          {
            localArrayList.add(paramArrayOfString[n]);
      ...
      localCursor = paramContentResolver.query(c.d, a, localStringBuilder.toString(), (String[])localArrayList.toArray(new String[0]), null);
    }
  ...
  {
    return ContentUris.withAppendedId(c.d, this.b).toString();
  }
