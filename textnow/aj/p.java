...
public final class p
{
  ...
  {
    private static URI b(textnow.al.a paramAnonymousa)
    {
  ...
  public static final s<j> P = new s()
  {
    ...
    private j b(textnow.al.a paramAnonymousa)
    {
  ...
  {
    private static BitSet b(textnow.al.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
      ...
      if (localb != b.b)
      {
        ...
        {
        default:
          throw new textnow.ag.q("Invalid bitset value type: " + localb);
        case 1:
        ...
        while (true)
        {
          ...
          {
            throw new textnow.ag.q("Error: Expecting: bitset number value (1, 0), Found: " + str);
          }
        }
      }
      paramAnonymousa.b();
  ...
  {
    private static Number b(textnow.al.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
      ...
      {
        throw new textnow.ag.q(localNumberFormatException);
      }
    }
  };
  ...
  {
    private static BigDecimal b(textnow.al.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
  ...
  {
    private static BigInteger b(textnow.al.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
