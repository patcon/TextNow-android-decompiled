  ...
  implements Animation.AnimationListener
{
  ...
  public c(Context paramContext, e parame)
  {
    ...
    Drawable localDrawable = getResources().getDrawable(2130838035);
    this.c.setImageDrawable(localDrawable);
    int i = getResources().getDimensionPixelSize(2131361826);
    ...
    default:
      j = 2130968588;
      k = 2130968594;
      setBackgroundResource(2130838037);
    case 1:
    }
    while (true)
    {
      ...
      j = 2130968587;
      k = 2130968593;
      setBackgroundResource(2130838036);
