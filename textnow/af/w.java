...
final class w<T> extends y<T>
{
  ...
  private final l<T> b;
  private final f c;
  private final textnow.aj.a<T> d;
  private final z e;
  private y<T> f;

  private w(t<T> paramt, l<T> paraml, f paramf, textnow.aj.a<T> parama, z paramz)
  {
    this.a = paramt;
    this.b = paraml;
    this.c = paramf;
  ...
  public static z a(textnow.aj.a<?> parama, Object paramObject)
  {
