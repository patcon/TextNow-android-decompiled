...
final class x
  implements z
{
  private final textnow.aj.a<?> a;
  private final boolean b;
  private final Class<?> c;
  private final t<?> d;
  private final l<?> e;

  private x(Object paramObject, textnow.aj.a<?> parama, boolean paramBoolean, Class<?> paramClass)
  {
    t localt;
    l locall;
  ...
  public final <T> y<T> a(f paramf, textnow.aj.a<T> parama)
  {
    boolean bool;
    if (this.a != null)
