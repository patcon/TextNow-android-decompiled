  ...
  implements a
{
  ...
  public d(Context paramContext, e parame, k paramk, TypedArray paramTypedArray)
  {
    ...
    {
    default:
      LayoutInflater.from(paramContext).inflate(2130903167, this);
      this.f = ((FrameLayout)findViewById(2131165612));
      this.h = ((TextView)this.f.findViewById(2131165615));
      this.c = ((ProgressBar)this.f.findViewById(2131165614));
      this.i = ((TextView)this.f.findViewById(2131165616));
      this.b = ((ImageView)this.f.findViewById(2131165613));
      ...
      default:
        if (paramk == k.a)
        {
          ...
          this.j = paramContext.getString(2131492980);
          this.k = paramContext.getString(2131492982);
          this.l = paramContext.getString(2131492981);
    ...
    while (true)
    {
      ...
      j();
      return;
      LayoutInflater.from(paramContext).inflate(2130903166, this);
      break;
      if (paramk == k.a);
      for (int m = 48; ; m = 3)
      {
        localLayoutParams.gravity = m;
        this.j = paramContext.getString(2131492986);
        this.k = paramContext.getString(2131492988);
        this.l = paramContext.getString(2131492987);
        break;
      }
      i2 = 5;
      break label179;
