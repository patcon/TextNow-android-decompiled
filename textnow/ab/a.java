...
public final class a extends SQLiteOpenHelper
{
  ...
  StringBuilder b = new StringBuilder("SELECT ").append("m.").append("_id").append(" AS ").append("_id").append(", ").append("m.").append("contact_value").append(" AS ").append("contact_value").append(", ").append("m.").append("contact_type").append(" AS ").append("contact_type").append(", ").append("m.").append("message_type").append(" AS ").append("message_type").append(", ").append("m.").append("message_text").append(" AS ").append("message_text").append(", ").append("m.").append("date").append(" AS ").append("date").append(", ").append("c.").append("contact_uri").append(" AS ").append("contact_uri").append(", ").append("c.").append("contact_name").append(" AS ").append("contact_name").append(" FROM ").append("messages").append(" AS ").append("m").append(" LEFT OUTER JOIN ").append("conversations").append(" AS ").append("c").append(" ON ").append("m.").append("contact_value").append(" = ").append("c.").append("contact_value");
  private Context c;
  private final String d = "create view view_conversations as " + this.a.toString() + ";";
  private final String e = "create view view_calls as " + this.b.toString() + ";";

  public a(Context paramContext)
  {
    super(paramContext, "textnow_data.db", null, 9);
    this.c = paramContext;
  }
  ...
  public final void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    if (paramInt1 < paramInt2)
    {
      if (paramInt1 == 1)
      {
        ...
        localStringBuilder6.append("ALTER TABLE ").append("messages").append(" ADD COLUMN ").append("state").append(" INTEGER DEFAULT 0");
    ...
    if (paramInt1 == 2)
    {
      ...
      localStringBuilder5.append("ALTER TABLE ").append("messages").append(" ADD COLUMN ").append("attach").append(" TEXT DEFAULT ''");
    ...
    if (paramInt1 == 3)
    {
      ...
      localStringBuilder3.append("ALTER TABLE ").append("conversations").append(" ADD COLUMN ").append("custom_wallpaper").append(" TEXT DEFAULT ''");
      paramSQLiteDatabase.execSQL(localStringBuilder3.toString());
      StringBuilder localStringBuilder4 = new StringBuilder();
      localStringBuilder4.append("ALTER TABLE ").append("conversations").append(" ADD COLUMN ").append("custom_ringtone").append(" TEXT DEFAULT ''");
    ...
    if (paramInt1 == 4)
    {
      ...
      localStringBuilder2.append("ALTER TABLE ").append("messages").append(" ADD COLUMN ").append("message_source").append(" INTEGER DEFAULT 0");
    ...
    if (paramInt1 == 7)
    {
      new StringBuilder().append("Upgrading database from version ").append(paramInt1).append(" to ").append(paramInt2).append(" => add contact notification disabled column").toString();
      StringBuilder localStringBuilder1 = new StringBuilder();
      localStringBuilder1.append("ALTER TABLE ").append("conversations").append(" ADD COLUMN ").append("notification_disabled").append(" INTEGER DEFAULT ''");
    ...
    if (paramInt1 == 8)
    {
      new StringBuilder().append("Upgrading database from version ").append(paramInt1).append(" to ").append(paramInt2).append(" => add call view").toString();
      paramSQLiteDatabase.execSQL("DROP VIEW  IF EXISTS view_calls");
      paramSQLiteDatabase.execSQL(this.e);
      onUpgrade(paramSQLiteDatabase, paramInt1 + 1, paramInt2);
      return;
    }
