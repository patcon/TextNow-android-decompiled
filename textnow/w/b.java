...
public final class b
{
  ...
  public static Uri a(ContentResolver paramContentResolver, Group paramGroup)
  {
    ...
    //   56: istore_3
    //   57: goto -48 -> 9
    //   60: getstatic 32	textnow/w/b:c	Ljava/util/Set;
    //   63: aload_1
    ...
    //   86: aastore
    //   87: aload_0
    //   88: getstatic 99	com/enflick/android/TextNow/persistence/contentproviders/e:d	Landroid/net/Uri;
    //   91: getstatic 21	textnow/w/b:a	[Ljava/lang/String;
    //   94: ldc 101
    //   96: aload 5
    //   98: aconst_null
    ...
    //   125: ifne +119 -> 244
    //   128: aload_0
    //   129: getstatic 99	com/enflick/android/TextNow/persistence/contentproviders/e:d	Landroid/net/Uri;
    //   132: aload_1
    //   133: invokestatic 118	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group;)Landroid/content/ContentValues;
    ...
    //   186: invokestatic 140	textnow/q/k:a	(Landroid/content/ContentResolver;Ljava/lang/String;I)Landroid/net/Uri;
    //   189: astore 13
    //   191: aload 13
    //   193: ifnull +13 -> 206
    //   196: aload 7
    ...
    //   212: invokestatic 146	textnow/q/k:b	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    //   215: astore 15
    //   217: aload_0
    //   218: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   221: aload 12
    //   223: aload_1
    //   224: getfield 66	com/enflick/android/TextNow/api/responsemodel/Group:contact_value	Ljava/lang/String;
    //   227: aload 15
    //   229: aload 13
    //   231: invokestatic 151	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group$GroupMember;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/ContentValues;
    ...
    //   273: astore 31
    //   275: getstatic 99	com/enflick/android/TextNow/persistence/contentproviders/e:d	Landroid/net/Uri;
    //   278: aload 31
    ...
    //   289: aload 32
    //   291: aload_1
    //   292: invokestatic 118	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group;)Landroid/content/ContentValues;
    //   295: ldc 101
    //   297: aload 5
    ...
    //   308: invokestatic 185	textnow/w/b:b	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/util/List;
    //   311: invokestatic 188	textnow/w/b:a	(Ljava/util/List;)Ljava/util/Set;
    //   314: astore 34
    ...
    //   370: invokestatic 140	textnow/q/k:a	(Landroid/content/ContentResolver;Ljava/lang/String;I)Landroid/net/Uri;
    //   373: astore 40
    //   375: aload 40
    //   377: ifnull +13 -> 390
    //   380: aload 7
    ...
    //   412: aastore
    //   413: aload_0
    //   414: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   417: getstatic 25	textnow/w/b:b	[Ljava/lang/String;
    //   420: ldc 190
    //   422: aload 42
    //   424: aconst_null
    ...
    //   436: invokestatic 146	textnow/q/k:b	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    //   439: astore 44
    //   441: aload 43
    //   443: ifnull +13 -> 456
    //   446: aload 43
    ...
    //   453: ifne +55 -> 508
    //   456: aload_0
    //   457: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   460: aload 39
    //   462: aload_1
    //   463: getfield 66	com/enflick/android/TextNow/api/responsemodel/Group:contact_value	Ljava/lang/String;
    //   466: aload 44
    //   468: aload 40
    //   470: invokestatic 151	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group$GroupMember;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/ContentValues;
    ...
    //   557: ifne +24 -> 581
    //   560: aload_0
    //   561: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   564: aload 39
    //   566: aload_1
    //   567: getfield 66	com/enflick/android/TextNow/api/responsemodel/Group:contact_value	Ljava/lang/String;
    //   570: aload 44
    //   572: aload 40
    //   574: invokestatic 151	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group$GroupMember;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/ContentValues;
    ...
    //   630: athrow
    //   631: aload_0
    //   632: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   635: aload 39
    //   637: aload_1
    //   638: getfield 66	com/enflick/android/TextNow/api/responsemodel/Group:contact_value	Ljava/lang/String;
    //   641: aload 44
    //   643: aload 40
    //   645: invokestatic 151	textnow/w/b:a	(Lcom/enflick/android/TextNow/api/responsemodel/Group$GroupMember;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/ContentValues;
    ...
    //   717: aastore
    //   718: aload_0
    //   719: getstatic 149	com/enflick/android/TextNow/persistence/contentproviders/d:d	Landroid/net/Uri;
    //   722: ldc 190
    //   724: aload 54
    ...
    //   785: invokestatic 185	textnow/w/b:b	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/util/List;
    //   788: astore 26
    ...
    //   827: checkcast 228	textnow/u/i
    //   830: invokevirtual 230	textnow/u/i:b	()Ljava/lang/String;
    //   833: invokeinterface 143 2 0
    //   838: pop
    //   839: goto -31 -> 808
    //   842: aload 27
    //   844: ldc 232
    //   846: invokestatic 237	textnow/q/b:a	(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/lang/String;
    //   849: astore 17
    //   851: aload_0
    //   852: aload_1
    //   853: getfield 66	com/enflick/android/TextNow/api/responsemodel/Group:contact_value	Ljava/lang/String;
    //   856: aload 17
    //   858: invokestatic 242	textnow/w/a:a	(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)V
    //   861: aload_1
    ...
    //   905: aload 7
    //   907: ldc 253
    //   909: invokestatic 237	textnow/q/b:a	(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/lang/String;
    //   912: astore 21
    ...
    //   974: aload 23
    //   976: aload 24
    //   978: invokestatic 262	textnow/w/a:a	(Landroid/content/ContentResolver;Ljava/lang/String;Landroid/content/ContentValues;)V
    //   981: aload 8
    //   983: astore 25
    //   985: goto -969 -> 16
    //   988: aconst_null
  ...
  private static Set<String> a(List<i> paramList)
  {
    HashSet localHashSet = new HashSet();
    Iterator localIterator = paramList.iterator();
    while (localIterator.hasNext())
      localHashSet.add(((i)localIterator.next()).a());
    return localHashSet;
  }

  // ERROR //
  public static textnow.u.h a(ContentResolver paramContentResolver, String paramString)
  {
    // Byte code:
    //   0: iconst_3
    ...
    //   28: astore_3
    //   29: aload_0
    //   30: getstatic 99	com/enflick/android/TextNow/persistence/contentproviders/e:d	Landroid/net/Uri;
    //   33: aload_2
    //   34: ldc 101
    //   36: aload_3
    //   37: aconst_null
    ...
    //   63: iload 9
    //   65: ifeq +68 -> 133
    //   68: new 269	textnow/u/h
    //   71: dup
    //   72: invokespecial 270	textnow/u/h:<init>	()V
    //   75: astore 10
    //   77: aload 10
    //   79: aload 4
    //   81: aload 4
    ...
    //   95: invokevirtual 273	textnow/u/h:b	(Ljava/lang/String;)V
    //   98: aload 10
    //   100: aload 4
    //   102: aload 4
    //   104: ldc 68
    ...
    //   116: invokevirtual 275	textnow/u/h:a	(Ljava/lang/String;)V
    //   119: aload 10
    //   121: aload_0
    //   122: aload_1
    //   123: invokestatic 185	textnow/w/b:b	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/util/List;
    //   126: invokevirtual 278	textnow/u/h:a	(Ljava/util/List;)V
    //   129: aload 10
    //   131: astore 5
    //   133: aload 4
  ...
  {
    paramContentResolver.update(e.d, paramContentValues, "contact_value=?", new String[] { paramString });
  }
  ...
  public static void a(ContentResolver paramContentResolver, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramContentResolver.insert(d.d, localContentValues);
  }
  ...
  public static List<i> b(ContentResolver paramContentResolver, String paramString)
  {
    ...
    Cursor localCursor = paramContentResolver.query(d.d, arrayOfString1, "contact_value=?", arrayOfString2, null);
    if (localCursor != null);
    try
    {
      if (localCursor.moveToNext())
        localArrayList.add(new i(localCursor.getString(localCursor.getColumnIndex("member_contact_value")), localCursor.getInt(localCursor.getColumnIndex("member_contact_type")), localCursor.getString(localCursor.getColumnIndex("member_display_name"))));
    }
    finally
    {
      if (localCursor != null)
  ...
  public static void c(ContentResolver paramContentResolver, String paramString)
  {
    ...
    int i = paramContentResolver.delete(c.d, "contact_value = ?", new String[] { paramString });
    new StringBuilder().append(i).append(" was deleted from Conversations").toString();
    int j = paramContentResolver.delete(f.d, "contact_value = ?", new String[] { paramString });
    new StringBuilder().append(j).append(" was deleted from Messages").toString();
    int k = paramContentResolver.delete(e.d, "contact_value = ?", new String[] { paramString });
    new StringBuilder().append(k).append(" was deleted from Groups").toString();
    int m = paramContentResolver.delete(d.d, "contact_value = ?", new String[] { paramString });
  ...
  public static boolean d(ContentResolver paramContentResolver, String paramString)
  {
    ...
    Cursor localCursor = paramContentResolver.query(e.d, a, "contact_value=?", arrayOfString, null);
    if (localCursor != null);
    while (true)
    {
      try
