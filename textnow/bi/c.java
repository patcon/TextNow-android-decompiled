...
{
  // ERROR //
  public static textnow.bg.d a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnull +582 -> 583
    ...
    //   19: astore 5
    //   21: new 27	textnow/bg/b
    //   24: dup
    //   25: invokespecial 28	textnow/bg/b:<init>	()V
    //   28: astore 6
    //   30: aload 5
    //   32: ldc 30
    ...
    //   289: astore 29
    //   291: new 88	textnow/bg/c
    //   294: dup
    //   295: invokespecial 89	textnow/bg/c:<init>	()V
    //   298: astore 30
    //   300: aload 30
    //   302: aload 29
    //   304: invokevirtual 92	textnow/bg/c:k	(Ljava/lang/String;)V
    //   307: aload 30
    //   309: aload 27
    //   311: invokevirtual 95	textnow/bg/c:i	(Ljava/lang/String;)V
    //   314: aload 30
    //   316: aload 22
    //   318: invokevirtual 98	textnow/bg/c:f	(Ljava/lang/String;)V
    //   321: aload 30
    //   323: iload 23
    //   325: invokevirtual 101	textnow/bg/c:a	(I)V
    //   328: aload 30
    //   330: aload 20
    //   332: invokevirtual 104	textnow/bg/c:d	(Ljava/lang/String;)V
    //   335: aload 30
    //   337: aload 28
    //   339: invokevirtual 107	textnow/bg/c:j	(Ljava/lang/String;)V
    //   342: aload 30
    //   344: aload 19
    //   346: invokevirtual 110	textnow/bg/c:c	(Ljava/lang/String;)V
    //   349: aload 30
    //   351: aload 21
    //   353: invokevirtual 113	textnow/bg/c:e	(Ljava/lang/String;)V
    //   356: aload 30
    //   358: aload 17
    //   360: invokevirtual 115	textnow/bg/c:a	(Ljava/lang/String;)V
    //   363: aload 30
    //   365: aload 18
    //   367: invokevirtual 118	textnow/bg/c:b	(Ljava/lang/String;)V
    //   370: aload 30
    //   372: aload 24
    //   374: invokevirtual 121	textnow/bg/c:g	(Ljava/lang/String;)V
    //   377: aload 30
    //   379: aload 26
    //   381: invokevirtual 124	textnow/bg/c:h	(Ljava/lang/String;)V
    //   384: aload 30
    //   386: iload 25
    //   388: invokevirtual 126	textnow/bg/c:b	(I)V
    //   391: aload 9
    //   393: aload 30
    ...
    //   405: aload 6
    //   407: aload 9
    //   409: invokevirtual 133	textnow/bg/b:a	(Ljava/util/ArrayList;)V
    //   412: aload 6
    //   414: aload 5
    //   416: ldc 84
    ...
    //   424: invokevirtual 134	textnow/bg/b:a	(Ljava/lang/String;)V
    //   427: aload 6
    //   429: aload 5
    //   431: ldc 136
    ...
    //   439: invokevirtual 137	textnow/bg/b:b	(Ljava/lang/String;)V
    //   442: aload 6
    //   444: aload 5
    //   446: ldc 70
    //   448: invokevirtual 74	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   451: invokevirtual 138	textnow/bg/b:a	(I)V
    //   454: aload 6
    //   456: aload 5
    //   458: ldc 68
    ...
    //   466: invokevirtual 139	textnow/bg/b:c	(Ljava/lang/String;)V
    //   469: new 141	textnow/bg/d
    //   472: dup
    //   473: invokespecial 142	textnow/bg/d:<init>	()V
    //   476: astore_3
    //   477: aload_3
    //   478: aload 6
    //   480: invokevirtual 145	textnow/bg/d:a	(Ltextnow/bg/b;)V
    //   483: aload_3
    //   484: aload_1
    //   485: ldc 147
    ...
    //   493: invokevirtual 148	textnow/bg/d:a	(Ljava/lang/String;)V
    //   496: aload_3
    //   497: aload_1
    //   498: ldc 76
    ...
    //   506: invokevirtual 149	textnow/bg/d:b	(Ljava/lang/String;)V
    //   509: aload_3
    //   510: areturn
    //   511: astore 11
    //   513: aload 11
