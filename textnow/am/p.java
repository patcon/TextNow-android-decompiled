...
final class p extends Handler
{
  ...
  {
    ArrayList localArrayList1 = (ArrayList)o.f().get();
    ArrayList localArrayList2 = (ArrayList)o.g().get();
    ...
    default:
      return;
    case 0:
      localArrayList5 = (ArrayList)o.h().get();
    ...
    while (true)
      ...
      else
      {
        ...
        ArrayList localArrayList3 = (ArrayList)o.i().get();
        ArrayList localArrayList4 = (ArrayList)o.j().get();
        ...
        if ((i == 0) || ((localArrayList1.isEmpty()) && (localArrayList2.isEmpty())))
          break;
        sendEmptyMessageDelayed(1, Math.max(0L, o.k() - (AnimationUtils.currentAnimationTimeMillis() - l)));
        return;
        i = 1;
      }
  }
