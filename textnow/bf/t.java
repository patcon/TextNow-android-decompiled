...
public final class t extends at
{
  ...
  public final ah b(as paramas, long paramLong)
  {
    ...
    if (localau != null)
    {
      ...
      PointF localPointF = textnow.be.t.a(f4, f5, this.e.c());
      ...
      if (this.e.a() != null)
      {
        ...
        Point localPoint = textnow.be.t.a(Math.round(localah.f), Math.round(localah.g), this.e.b());
        f6 = f10 + localPoint.x;
        f7 = f11 + localPoint.y;
      }
