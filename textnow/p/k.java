...
{
  public k(Context paramContext, Cursor paramCursor)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2130903105, paramViewGroup, false);
  }

  public final void a(View paramView, Context paramContext, Cursor paramCursor)
  {
    TextView localTextView1 = (TextView)paramView.findViewById(2131558626);
    TextView localTextView2 = (TextView)paramView.findViewById(2131558627);
