...
public final class p
{
  ...
  {
    private static URI b(textnow.ae.a paramAnonymousa)
    {
  ...
  public static final y<m> P = new y()
  {
    ...
    private m b(textnow.ae.a paramAnonymousa)
    {
      ...
      textnow.z.p localp = new textnow.z.p();
      paramAnonymousa.c();
      while (paramAnonymousa.e())
  ...
  {
    private static BitSet b(textnow.ae.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
  ...
  {
    private static Number b(textnow.ae.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
  ...
  {
    private static BigDecimal b(textnow.ae.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
  ...
  {
    private static BigInteger b(textnow.ae.a paramAnonymousa)
    {
      if (paramAnonymousa.f() == b.i)
      {
        paramAnonymousa.j();
  ...
  public static <TT> z a(textnow.ad.a<TT> parama, final y<TT> paramy)
  {
    return new z()
    {
      public final <T> y<T> a(f paramAnonymousf, textnow.ad.a<T> paramAnonymousa)
