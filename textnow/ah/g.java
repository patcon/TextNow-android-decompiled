  ...
  implements Cloneable, z
{
  ...
  private boolean a(textnow.ag.c paramc, d paramd)
  {
    int i;
  ...
  public final <T> y<T> a(final f paramf, final textnow.aj.a<T> parama)
  {
    ...
    return new y()
    {
      ...
      public final T a(textnow.ak.a paramAnonymousa)
      {
        if (bool2)
        {
          paramAnonymousa.n();
      ...
      public final void a(textnow.ak.c paramAnonymousc, T paramAnonymousT)
      {
        if (bool1)
        {
          paramAnonymousc.f();
  ...
  {
    if ((this.b != -1.0D) && (!a((textnow.ag.c)paramClass.getAnnotation(textnow.ag.c.class), (d)paramClass.getAnnotation(d.class))))
      return true;
  ...
  public final boolean a(Field paramField, boolean paramBoolean)
  {
    if ((this.c & paramField.getModifiers()) != 0)
      return true;
    if ((this.b != -1.0D) && (!a((textnow.ag.c)paramField.getAnnotation(textnow.ag.c.class), (d)paramField.getAnnotation(d.class))))
      return true;
    if (paramField.isSynthetic())
      return true;
    if (this.e)
    {
      textnow.ag.a locala = (textnow.ag.a)paramField.getAnnotation(textnow.ag.a.class);
      if (locala != null)
      {
        if (!paramBoolean)
          break label100;
