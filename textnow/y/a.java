...
public final class a
  implements com.enflick.android.TextNow.activities.phone.f, GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener
{
  private Context a;
  ...
  {
    this(paramContext, paramd, 5);
  }

  private a(Context paramContext, d paramd, int paramInt)
  {
    this.a = paramContext;
    ...
    arrayOfString1[0] = textnow.q.b.f(this.a);
    a(arrayOfString1);
  ...
  public final void a(long paramLong)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        label739: Call.Statistics localStatistics = this.f.p().l();
        String[] arrayOfString3 = new String[2];
